    ...
    highlight_overrides = {
      all = function(colors)
        return {
          ...
          TSTitle = { link = "Title" },
          TSTodo = { link = "Todo" },
          TSType = { fg = "#4ec9b0", style = { "bold" } },
          TSTypeBuiltin = { fg = colors.lavender, style = { "bold" } },
          TSTypeDefinition = { fg = colors.lavender, style = { "bold" } },
          TSTypeQualifier = { fg = colors.lavender, style = { "bold" } },
          ...
          ["@lsp.typemod.function.declaration.typescriptreact"] = { link = "TSMethod"},
          ["@lsp.typemod.function.readonly.typescriptreact"] = { link = "TSMethod"},
          ["@lsp.typemod.parameter.declaration.typescriptreact"] = { link = "TSParameter"},
